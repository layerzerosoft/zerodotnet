...
namespace LayerZero.Fulfillment.Kafka.Processing;

public static class KafkaFulfillmentProcessingHost
{
    public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddMessaging(ResolveApplicationName(configuration))
            .AddKafka(configuration, role: MessageTransportRole.Consumers);
    }
